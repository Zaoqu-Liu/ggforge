...
Create violin plots with optional grouping, faceting, and statistical
comparisons. Violin plots combine box plots with kernel density
estimation to show the distribution shape of continuous data.
