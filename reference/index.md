...
Functions for survival and clinical data analysis
...
- [`themes`](https://zaoqu-liu.github.io/ggforge/reference/themes.md) :
  ggforge Theming System
- [`theme_ggforge()`](https://zaoqu-liu.github.io/ggforge/reference/theme_ggforge.md)
  : Main ggforge Theme
- [`theme_ggforge_grid()`](https://zaoqu-liu.github.io/ggforge/reference/theme_ggforge_grid.md)
  : ggforge Theme for Grid-based Plots (Heatmap-like)
- [`theme_minimal_axes()`](https://zaoqu-liu.github.io/ggforge/reference/theme_minimal_axes.md)
  : Minimal Theme
- [`palettes`](https://zaoqu-liu.github.io/ggforge/reference/palettes.md)
  : Color Palette System for ggforge
- [`get_palette()`](https://zaoqu-liu.github.io/ggforge/reference/get_palette.md)
  : Get colors from palette
- [`show_palettes()`](https://zaoqu-liu.github.io/ggforge/reference/show_palettes.md)
...
- [`dim_example`](https://zaoqu-liu.github.io/ggforge/reference/dim_example.md)
  : Example Dimensionality Reduction Data
- [`enrich_example`](https://zaoqu-liu.github.io/ggforge/reference/enrich_example.md)
  : Example Enrichment Analysis Data
- [`enrich_multidb_example`](https://zaoqu-liu.github.io/ggforge/reference/enrich_multidb_example.md)
  : Example Multi-Database Enrichment Data
- [`gsea_example`](https://zaoqu-liu.github.io/ggforge/reference/gsea_example.md)
  : Example GSEA Results
- [`palette_list`](https://zaoqu-liu.github.io/ggforge/reference/palette_list.md)
  : Color Palette Collection
- [`words_excluded`](https://zaoqu-liu.github.io/ggforge/reference/words_excluded.md)
...
- [`var_type()`](https://zaoqu-liu.github.io/ggforge/reference/var_type.md)
