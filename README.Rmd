...
ggforge is a comprehensive and elegant visualization framework designed specifically for biomedical and bioinformatics research. Built on ggplot2 with a modern modular architecture, it streamlines the creation of high-quality figures with minimal code while maintaining full flexibility for customization.

## ✨ Key Features

- 🎨 **40+ Plotting Functions** - Comprehensive coverage of biomedical visualization needs
- 🧬 **Bioinformatics-Focused** - Specialized functions for enrichment, GSEA, single-cell, genomics
- 🎯 **Unified API Design** - Consistent interface across all plotting functions
- 🌈 **Extensive Color Palettes** - Carefully curated color schemes for scientific research
- 🔧 **Intelligent Type Detection** - Automatic variable type inference for optimal styling
- 📊 **Multi-Panel Layouts** - Easy creation of complex figure compositions
...
```{r violinplot, fig.width=9, fig.height=6}
ViolinPlot(
  data = data,
  x = "group",
  y = "value",
...
```{r velocity, fig.width=10, fig.height=8}
...
```{r kmplot, fig.width=9, fig.height=7}
...
```{r chordplot, fig.width=8, fig.height=8}
...
```{r split-example, fig.width=12, fig.height=4}
...
*MD candidate and PhD student at Chinese Academy of Medical Sciences and Peking Union Medical College*

## 🙏 Acknowledgments

This package is greatly inspired by and modified from [plotthis](https://github.com/pwwang/plotthis) by Panwen Wang. We are deeply grateful for the original work and design philosophy.

Built on the shoulders of giants:
- [plotthis](https://github.com/pwwang/plotthis) - Original inspiration and foundation
- [ggplot2](https://ggplot2.tidyverse.org/) - The grammar of graphics
- [patchwork](https://patchwork.data-imaginist.com/) - Multi-panel composition
